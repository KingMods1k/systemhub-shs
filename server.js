      ...
      result = await rhs.updateOne(
        { _id: new ObjectId(funcionarioId), 'documentos._id': new ObjectId(substituirId) },
        {
          $set: {
            ...
            'documentos.$.arquivo_cifrado': newCiphertext.toString('base64'),
            'documentos.$.chave_cifrada': encryptedAesKeyServer.toString('base64'),
            'documentos.$.iv': newIv.toString('base64'),
            'documentos.$.auth_tag': newAuthTag.toString('base64'),
            'documentos.$.assinatura': signature.toString('base64'),
        ...
        { _id: new ObjectId(funcionarioId) },
        {
          $push: {
            documentos: {
              _id: new ObjectId(),
              mimetype,
              arquivo_cifrado: newCiphertext.toString('base64'),
              chave_cifrada: encryptedAesKeyServer.toString('base64'),
              iv: newIv.toString('base64'),
              auth_tag: newAuthTag.toString('base64'),
